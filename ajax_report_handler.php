...
// --- Check if the request is for the custom report ---
// This handler is dedicated, but check action for good measure and future flexibility
if (!($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'generate_custom_report')) {
     send_error_response("Invalid Request.", 400);
}
